...
const paymentService = {
  ...
  verifyConsultancyPayment: serviceHandler(async (data) => {
    ...
    try {
      ...
      // Send booking notification to the teacher (but NOT create payment request yet)
      try {
        ...
        console.error("Payment Service: Failed to send booking notification:", error);
        // Don't fail the payment process if notification fails
      }

      console.log("Payment Service: Consultancy payment verified, earnings created, and booking created");
      console.log("Payment Service: NOTE - Payment request will be created by expert after consultancy completion");
